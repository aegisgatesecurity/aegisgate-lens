/* SPDX-License-Identifier: Apache-2.0
   ...
   This module operates only on digit strings extracted by the
   detector regexes; it does not touch prompt/URL/page content
   directly, so it has no privacy implications under
   legal/AEGISGATE-LENS-LEGAL-DEVELOPER-CONSTRAINTS.md §4.
...
(function () {
   ...
   *
   * @param {string} s The candidate string (e.g., "4111-1111-1111-1111"
   *   or "4111111111111111"). Non-digit characters are ignored.
   * @returns {boolean} true if the digit sequence passes the Luhn check.
   */
   ...
   *
   * @type {ReadonlyArray<{network: string, number: string}>}
   */
   ...
   */
  const INVALID_CARDS = Object.freeze([
  ...
  NS.detectors.luhn = Object.freeze({
    isLuhnValid,
    TEST_CARDS,
    INVALID_CARDS,
  });
