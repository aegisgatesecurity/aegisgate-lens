...
(function (global) {
  ...
  // discriminator that says which facet fired.
  var VALID_FACETS = [1, 2, 3, 4, 5, 6];
  ...
  //
  // Format: { facetNumber: [category, category, ...] }
  var VALID_CATEGORIES = {
    ...
    4: [ // Compliance (OWASP / ATLAS / EU AI Act / etc.)
  ...
  function validateEvent(event) {
    ...
    // Build the cleaned event. We intentionally do NOT include
    // event.text, event.prompt, event.url, event.page_content, etc.
