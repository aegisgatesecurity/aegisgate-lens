...
(function () {
  ...
  /**
   * v0.2: Health check. Returns the parsed JSON body from the server
   * (e.g., { status: 'ok', version: '...' }). v0.1 returned a boolean,
   * v0.2 returns the body so callers can read the version field.
   */
